var NodeController = function(benchController) {
  ...
  this.create = function(nodeId, benchId, x, y, w, h, title, dataType, data, userName, userId) {
    $("#workbench").append('<div id="node-' + nodeId + '" class="node" data-nodeid=' + nodeId + ' style="width: ' + w + 'px; height: ' + h + 'px; left:' + x + '; top:' + y + '"><div class="title">' + title + '</div><div class="body"></div></div>');
